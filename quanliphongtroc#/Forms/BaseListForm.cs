...
//    {
//        // ─── Palette (Light Mode) ─────────────────────────────────────────
//        protected readonly Color BG = Color.FromArgb(243, 244, 246);
//        protected readonly Color PANEL = Color.White;
//        protected readonly Color CARD = Color.White;
//        protected readonly Color ACCENT = Color.FromArgb(79, 70, 229);
//        protected readonly Color ADIM = Color.FromArgb(99, 102, 241);
//        protected readonly Color GREEN = Color.FromArgb(16, 185, 129);
//        protected readonly Color RED = Color.FromArgb(220, 38, 38);
//        protected readonly Color YELLOW = Color.FromArgb(234, 179, 8);
//        protected readonly Color TEXT = Color.FromArgb(30, 41, 59);
//        protected readonly Color SEC = Color.FromArgb(100, 116, 139);
//        protected readonly Color BORDER = Color.FromArgb(226, 232, 240);
...
//            };
//            BtnSave = Btn("💾  Lưu", GREEN, Point.Empty, 115);
//            // Đã đổi màu nút Hủy sang xám nhạt cho hợp nền trắng
//            BtnCancel = Btn("✖  Hủy", Color.FromArgb(148, 163, 184), Point.Empty, 90);
//            BtnSave.Click += (s, e) => OnSave();
//            BtnCancel.Click += (s, e) => OnCancel();
//            AddFormButtons(PnlForm);
//            SetFormEnabled(false);
...
//            // Đã đổi màu nền tiêu đề cột sang xám nhạt
//            g.ColumnHeadersDefaultCellStyle.BackColor = Color.FromArgb(233, 236, 239);
//            g.ColumnHeadersDefaultCellStyle.ForeColor = SEC;
//            g.ColumnHeadersDefaultCellStyle.Font = new Font("Segoe UI", 9f, FontStyle.Bold);
//            return g;
//        }
...
namespace quanliphongtro.Forms
{
    public class BaseListForm : Form
    {
        ...
        protected virtual int FormPanelWidth => 400;
        protected virtual bool HasSearch => true;
        ...
        // ─── Virtual hooks (đã đổi từ abstract sang virtual) ──────────────
        protected virtual Panel BuildFormPanel() => new Panel();
        protected virtual DataGridView BuildGrid() => MakeGrid();
        protected virtual void LoadData() { }
        protected virtual void FillForm(DataGridViewRow row) { }
        protected virtual void SaveNew() { }
